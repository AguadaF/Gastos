<%-- 
    Document   : movimienInsert
    Created on : 08/11/2018, 17:45:10
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container bg-sucess" style="padding-top: 30px; padding-botton: 30px;">
            <h2>Carga Nuevos Movimientos</h2>
            <form action="Movimien?action=INSERT" method="post">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <input type="date" class="form-control" name="fecha" name="fecha" value="${movimien.fecha}" >
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-2">
                        <input type="text" class="form-control" name="importe" value="0">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-3">                    
                        <input type="text" class="form-control" name="conce">
                    </div>                    
                </div>
