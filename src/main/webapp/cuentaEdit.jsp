<%-- 
    Document   : cuentaEdit
    Created on : 18/10/2018, 17:15:11
...
<html lang="en">
    ...
    <body>
        ...
        <div class="container bg-sucess" style="padding-top: 30px; padding-botton: 30px;">
            <h2>Consulta, Modifica Cuentas</h2>
            <form action="Cuenta?action=UPDATE" method="post" id="cuenta">                

                <input type="hidden" id="action" name="action" value="${action}">

                <div class="form-group row">
                    <label for="numero" class="col-sm-1 col-form-label">Id</label>
                    <div class="col-sm-2">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="descrip" id="descrip" value="${cuenta.nombre}">
                    </div>
                </div>
                    ...
                    <div class="col-sm-2">
                        <SELECT class="form-control" size=1 cols=2 NAME="tipo" id="tipo">
                            ...
                            <c:if test="${cuenta.tipo == 2}">
                                ...
                                <OPTION value=2 selected="Egreso"> Egreso</option>
                                </c:if>                                          
